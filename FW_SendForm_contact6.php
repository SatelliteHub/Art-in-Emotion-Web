...
// E-Mail
$recipient = "nathanconart@gmail.com"; // Address to deliver form to
$subject = "artinemotion - Contact"; // Subject of the E-Mail
...
$errorStrings = array(
    ...
    4 => 'sendForm85973', // No real error message for this
);
